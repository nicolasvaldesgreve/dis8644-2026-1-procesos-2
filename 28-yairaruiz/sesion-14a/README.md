...
El proceso fue muy ordenado porque, al tener el archivo de las PCB, ordenar los componentes se hizo más rápido. Al momento de soldar me costó un poco tomarle el ritmo, sobre todo al soldar las patitas de los “zapatos” de los chips, ya que eran muy cortitas y al principio me costaba. 
...
https://youtube.com/shorts/HVa3SQPK91A?feature=share

También se me olvida mencionar que el día anterior empezamos a armar el BOM actualizado para tener todos los componentes ordenados para soldar.
...
+ El espectador no solo mira, también decide qué es la obra.
+ No existe una versión única de una obra. Todo puede repetirse, copiarse y cambiar.
+ El cine no tiene que ser coherente ni realista para existir.
+ La película no está solo en la pantalla, sino en la reacción de quien la ve.
